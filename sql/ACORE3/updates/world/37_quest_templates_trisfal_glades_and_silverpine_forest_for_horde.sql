...
UPDATE `quest_template` SET `OfferRewardText` = 'Most excellent! A new recruit has arrived. There is much to do... much to do I say. ' WHERE `entry` IN (26964,28568);

-- The Warchief Cometh --
UPDATE `quest_template` SET `OfferRewardText` = 'Stand at attention, $Nnub! ', `RequestItemsText` = 'Well that was unexpected. I am not one to doubt our Warchief, but...$B$BNevermind! We have work to do. I''m sure the Dark Lady and the Warchief will get this all worked out. ' WHERE `entry` = 26965;
