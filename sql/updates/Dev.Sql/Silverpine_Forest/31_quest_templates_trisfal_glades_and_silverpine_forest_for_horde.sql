...
UPDATE `quest_template` SET `OfferRewardText` = 'Most excellent! A new recruit has arrived. There is much to do... much to do I say. ', `ExclusiveGroup` = '26964', `NextQuestId` = '26965', `NextQuestInChain` = '26965', `OfferRewardEmote1` = '21', `OfferRewardEmoteDelay1` = '1500' WHERE `entry` = 26964;

-- Warchief's Command: Silverpine Forest! --
UPDATE `quest_template` SET `OfferRewardText` = 'Most excellent! A new recruit has arrived. There is much to do... much to do I say. ', `ExclusiveGroup` = '26964', `NextQuestId` = '26965', `NextQuestInChain` = '26965', `OfferRewardEmote1` = '21', `OfferRewardEmoteDelay1` = '1500' WHERE `entry` = 28568;

-- The Warchief Cometh --
UPDATE `quest_template` SET `OfferRewardText` = 'Stand at attention, $Nnub! ', `RequestItemsText` = 'Well that was unexpected. I am not one to doubt our Warchief, but...$B$BNevermind! We have work to do. I''m sure the Dark Lady and the Warchief will get this all worked out. ', `DetailsEmote1` = '1', `DetailsEmoteDelay1` = '1500', `DetailsEmote2` = '66', `DetailsEmoteDelay2` = '3000'  WHERE `entry` = 26965;
...
UPDATE `quest_template` SET `OfferRewardText` = 'Do you know why Mortuus appends ''nub'' to your name, <name>? Because he is an incompetent sycophant that has trouble seeing through his oversized helmet. ''NUB'' is your classification. You are now part of the NEW UNDERCITY BATALLION.$B$BBut enough with the comedy! I sent Deathstalker Yorick on a shadow operation two days ago. Her goal was to get information on the Gilneas Liberation Front and return. Three days and no word from her.$B$BHead southwest to the Ivar Patch and look for Yorick, $N. ' WHERE `entry` = 27039;

-- Waiting to Exsanguinate --
UPDATE `quest_template` SET `OfferRewardText` = 'Alas, poor Yorick! I knew her, $N. An assassin of infinite courage...$B$BNow, tell me what''s going on? What did you and Yorick discover? ' WHERE `entry` = 27045;
