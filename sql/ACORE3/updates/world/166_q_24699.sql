ALTER TABLE `world_db_version` CHANGE  `required_165_STV` `required_166_q_24699`  BIT(1);
...
(NULL,38307,1,1,1,0,0,-6804.87,-1687.18,-271.6,0.318869,300,0,0,55,0,0,2,0,0,0);
