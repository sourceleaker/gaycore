ALTER TABLE `world_db_version` CHANGE  `required_21_from_old_repository` `required_22_arathi_highlands`  BIT(1);
...
We\'ve got some interesting things to check into here, $C. ', RequestItemsText='',NextQuestInChain=26110 WHERE entry=26113;#Quae and Kinelory#
...
Have you had any luck yet? ', PrevQuestId=26110,NextQuestInChain=26114 WHERE entry=26110;#Just Like Old Times#
...
When you\'re prepared, come let me know. We\'ll get started right away. ', RequestItemsText='',PrevQuestId=26110 WHERE entry=26114;#Quae Trust You#
UPDATE quest_template SET OfferRewardText='You\'ve done a great service for us, $N. Thank you.\n
I hope Kin wasn\'t too much of a handful down there. She\'s very friendly, but can be just as deadly when you\'re her enemy.', RequestItemsText='You\'d best keep with Kinelory. I rust you, but if something happens to her. I won\'t be accountable for my actions.',SpecialFlags=2 WHERE entry=26116;#Kinelory Strikes#
UPDATE quest_template SET OfferRewardText='I admit I\'m impressed, $N. It\'s a small comfort amidst all that\'s happened here.\n
You have fought the undead, struck back against the Horde, and honored the memory of the victims of Southshore. On behalf of the kingdom of Stromgarde, I present you with an official commendation, and this reward. ', RequestItemsText='',PrevQuestId=26116 WHERE entry=26117;#For Southshore#
...
UPDATE quest_template SET SpecialFlags=2 WHERE entry=26050;
...
UPDATE quest_template SET SpecialFlags=2 WHERE entry=26628;
...
UPDATE quest_template SET OfferRewardText='The goggles work perfectly now! Well done, $N. ',RequestItemsText='', NextQuestInChain=26051 WHERE entry=26050;#Google Boogle#
...
Oh, and I\'ll need those goggles back when you\'re done. I am sure Captain O\'Breen will have many uses for them later on.', PrevQuestId=26050,NextQuestId=26052,SrcSpell=95675 WHERE entry=26051;#Sunken Treasure#
...
Maybe I can find some knitting needles so you can keep yourself busy.',SrcSpell=95675 WHERE entry=26055;#Drowned Sorrows#
UPDATE quest_template SET OfferRewardText='Ahoy, $C. Any friend of Skuerto is a friend of mine.\n
You\'ll find plenty of work needs doin\' around here. We\'re not sittin\' in this cove twiddlin\' our thumbs by choice. ',RequestItemsText='' WHERE entry=26336;#Shakes O'Breen#
UPDATE quest_template SET OfferRewardText='So the little gnomes proved their worth after all? I knew we kept those ankle biters around for a reason!',RequestItemsText='Ahoy, $C.  What brings you to the bridge?',PrevQuestId=26051,NextQuestId=26628 WHERE entry=26052;#Speak to Shakes#
...
Even if you are a puny $R.... ',RequestItemsText='',PrevQuestId=26052, SpecialFlags=2 WHERE entry=26628;#Death From Below#

DELETE FROM creature_questrelation WHERE id = 2610;
INSERT INTO creature_questrelation VALUES
('2610', '26628');

UPDATE quest_template SET OfferRewardText='Very good, $N.  The last thing we need with the undead looming is a gang of common thieves distracting us.', RequestItemsText='This is vital to the survival of Stromgarde, Raknar. Do not waste time.' WHERE entry=26093;#Northfold Manor"
...
It will be grim news to bear, but it is better than the uncertainty of a missing loved one. ', RequestItemsText='Have you retrieved any Stromgarde Badges, $N?  The Syndicate must learn they cannot profit from our dead. ', PrevQuestId=26093 WHERE entry=26095;#Stromgarde Badges#

UPDATE quest_template SET OfferRewardText='Not bad. Since it\'s clear you\'ve got your head on straight, I was hoping you could help us with a more pressing job. ', RequestItemsText='Have you had any luck so far? ', NextQuestInChain=26036 WHERE entry=26035;#Worth Its Weight in Gold#
...
Take a rest an\' get your strength back--the next phase of my plan\'ll require a little more time an\' effort. Come back to me after you\'ve gotten a warm meal an\' some rest. ', RequestItemsText='Our goal is the wand, $N. Focus on that for now. ', PrevQuestId=26035,NextQuestInChain=26037 WHERE entry=26036; #Wand over Fist#

UPDATE quest_template SET OfferRewardText='You amaze me, $N. Well done again.\n
Give me a moment to cast the proper spell an\' you\'ll be ready. ', RequestItemsText='$N, hello again. Have you found an azure agate yet? ',PrevQuestId=26036,NextQuestInChain=26038 WHERE entry=26037;
...
He\'ll be pleased to see what an overwhelming success our mission\'s been. ', RequestItemsText='You do this, an\' I\'m sure Malin\'ll be more than pleased with you. ',PrevQuestId=26037 WHERE entry=26038;#Attack on the Tower#

UPDATE quest_template SET OfferRewardText='<The shards pulse softly, and a whisper slowly echoes through your head.>\n
Help... ',RequestItemsText='',NextQuestInChain=26039 WHERE entry=26341;#The Stone Shards#
UPDATE quest_template SET OfferRewardText='Ah!  You activated these shards.  Already I feel more myself!\n
But alas, I am still far from free... ',RequestItemsText='This cluster of shards looks much like the Shards of Myzrael.  But the same feeling of security does not pulse through them. ', PrevQuestId=26341,NextQuestInChain=26041 WHERE entry=26039;#The Princess Trapped#
...
You are a noble $C, $N.  My rescuer! ',RequestItemsText='This is the Stone of Inner Binding.  It is the strongest of the binding stones and must be unlocked for the others to open.',PrevQuestId=26039,NextQuestInChain=26042 WHERE entry=26041;#Stones of Binding#

UPDATE quest_template SET OfferRewardText='You place the rod in the keystone.  And a shudder is felt beneath you... ',RequestItemsText='The Keystone is charged with tremendous geomantic energy. ',PrevQuestId=26041,NextQuestId=26346 WHERE entry=26042;
...
We\'ve both made a grave mistake in involving ourselves in this. Luckily, I "persuaded" my boy Gerrig to tell me what to do if this happened. ', RequestItemsText='',PrevQuestId=26042,NextQuestInChain=26049 WHERE entry=26349;#Myzrael's Tale#
...
The Shards of Myzrael no longer invoke feelings of warmth and security as they once did.  Now they pulse with an open menace... as if the thing beneath them holds ill will toward the surface. ',RequestItemsText='The Shards of Myzrael are now strangely quiet. ',PrevQuestId=26346 WHERE entry=26049;#The Princess Unleashed#
