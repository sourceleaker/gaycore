...
enum BG_BG_NodeObjectId
{
    ...
    BG_BG_OBJECTID_NODE_BANNER_1    = 208785,       // Waterworks banner
    BG_BG_OBJECTID_NODE_BANNER_2    = 208782,       // Mine banner
};
const uint32 NodeID[3] = {BG_BG_OBJECTID_NODE_BANNER_0, BG_BG_OBJECTID_NODE_BANNER_1, BG_BG_OBJECTID_NODE_BANNER_2};
