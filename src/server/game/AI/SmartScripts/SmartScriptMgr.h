...
enum SMART_ACTION
{
    ...
    SMART_ACTION_MOVE_TO_POS                        = 69,     // run, entry, distance  Position must be set to TERGET_POSITION x, y, z
    ...
    SMART_ACTION_LEAVE_VEHICLE                      = 100,     // Leave Vehicle
    SMART_ACTION_REMOVE_PASSENGERS                  = 101,    // Remove Passengers
