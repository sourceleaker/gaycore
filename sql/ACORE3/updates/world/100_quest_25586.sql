ALTER TABLE `world_db_version` CHANGE  `required_99_quest_24686` `required_100_quest_25586`  BIT(1);
...
(40869,60080,25586,1,25586,2,0,0,0),
(40869,60080,25585,1,25585,2,0,0,0);
